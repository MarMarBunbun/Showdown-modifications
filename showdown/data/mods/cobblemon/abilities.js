...
const Abilities = {
  absolutezero: {
    ...
    onBasePower(basePower, attacker, defender, move) {
      if (move.type === "Ice" && (this.field.isWeather("snow") || this.field.isWeather("hail"))) {
        ...
        return this.chainModify([5325, 4096]); // ≈ 1.3× boost
      }
    },
    flags: {},
    name: "Absolute Zero",
  ...
  globetrotter: {
    ...
    rating: 2,
    num: 3255
    // Hazard and Field Condition Immunity implemented in moves.ts and conditions.ts
  },
  grasspelt: {
  ...
  snowysurge: {
    onStart(source) {
      this.field.setTerrain("snowyterrain");
    },
    flags: {},
    name: "Snowy Surge",
    rating: 4,
  ...
  toxicvoice: {
	...
	onModifyType(move, pokemon) {
      if ((move.flags['sound'] || move.type === "Sound") && !pokemon.volatiles['dynamax']) { // hardcode
        move.type = 'Poison';
      }
	},
	flags: {},
