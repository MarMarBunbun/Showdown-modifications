package drai.dev.gravelsextendedbattles.tooltips
...
object GravelmonTooltipGenerator : TooltipGenerator() {
    ...
    override fun generateTooltip(stack: ItemStack, lines: MutableList<Component>): MutableList<Component>? {
        ...
        if (stack.item.builtInRegistryHolder().unwrapKey().isPresent && stack.item.builtInRegistryHolder().unwrapKey().get().location().namespace == "gravelmon") {
