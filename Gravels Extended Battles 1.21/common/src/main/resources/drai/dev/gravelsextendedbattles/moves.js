...
const Moves = {
  ...
  steamburst: {
    // power boost handled in conditions
    num: 3877,
    accuracy: 100,
    basePower: 75,
    category: "Special",
  ...
  turbulence: {
    ...
    condition: {
      // Weather and Terrain Suppression implemented in field.ts and pokemon.ts
      duration: 3,
    },
    secondary: null,
    target: "allAdjacent",
