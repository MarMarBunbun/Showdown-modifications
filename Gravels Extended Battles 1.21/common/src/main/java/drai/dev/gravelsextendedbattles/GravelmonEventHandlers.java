...
//            if (post.getReceived().getItem() instanceof MemoryItem Item) {
//                playHeldItemFormeChange(pokemon.getEntity());
//                new StringSpeciesFeature("rks_memory", Item.getType()).apply(pokemon);
//            }
...
//                return;
//            }
//            if (item instanceof ZCrystalItem Item) {
//                playHeldItemFormeChange(pokemon.getEntity());
...
//    }
//
//    private static void changeArceusForm(HasType Item, Pokemon pokemon) {
...
//                ResourceLocation.tryParse("cobblemon:arceus_" + Item.getType()), List.of("target"));
//        pokemon.getEntity().getEntityData().set(PokemonEntity.getEVOLUTION_STARTED(), true);
//
//        pokemon.getEntity().after(3F, () -> {
//            new StringSpeciesFeature("multitype", Item.getType()).apply(pokemon);
//            SnowStormHandler.Companion.playAnimation(pokemon.getEntity(), Set.of("cry"), List.of());
