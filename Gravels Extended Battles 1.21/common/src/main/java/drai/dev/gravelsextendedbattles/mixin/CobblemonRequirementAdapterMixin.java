...
import drai.dev.gravelsextendedbattles.requirements.*;
...
public abstract class CobblemonRequirementAdapterMixin {
    @Shadow public abstract <T extends Requirement> void registerType(@NotNull String id, @NotNull KClass<T> type);
    ...
    private void executeInject(CallbackInfo ci) {
        ...
        types.put(FriendshipBelowRequirement.ADAPTER_VARIANT, FriendshipBelowRequirement.class);
    }
}
